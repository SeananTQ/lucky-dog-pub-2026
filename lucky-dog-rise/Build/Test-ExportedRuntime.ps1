...
if ($Channel -eq 'Demo') {
    $expectedCapabilities = '[BuildCapabilities] Channel=Demo, BlindBoxes=True, CollectionEvents=True, LinkTree=False, SteamInventory=False, PlatformStatistics=False, Achievements=False, SteamCloud=True'
