...
exclude_filter="addons/*,Tools/*,docs/*,Scenes/Test*.tscn,Scenes/Debug/*,Scripts/Desktop/SteamMockPanelController.cs*,Scripts/Platform/DebugSteamMockPlatformService.cs*,Scripts/Platform/IDebugSteamMockController.cs*,Scenes/UIThemePreview.tscn,Scenes/LocalizationLayoutLab.tscn,Assets/v1/layer_index_old.json,Themes/DefaultTheme_V1Bak.tres"
