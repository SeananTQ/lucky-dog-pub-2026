...
public static class L10nKey
{
    ...
    public const string Settings_PokerGuideOverlay = nameof(Settings_PokerGuideOverlay);
    ...
    public const string Settings_DesktopPetScaleSwitchModeTitle = nameof(Settings_DesktopPetScaleSwitchModeTitle);
    public const string Settings_DesktopPetScaleSwitchModeMessage = nameof(Settings_DesktopPetScaleSwitchModeMessage);
    public const string Settings_DesktopPetScaleSwitchModeNow = nameof(Settings_DesktopPetScaleSwitchModeNow);
    ...
    public const string RecoveredItems_Confirm = nameof(RecoveredItems_Confirm);
