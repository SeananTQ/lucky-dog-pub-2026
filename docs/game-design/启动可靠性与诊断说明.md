...
盲盒直接奖励架构已经完成进程内 Mock 验收，包括七种网络场景、新手 12 条 Schedule、第 5 / 第 12 个进度回执、普通循环交接、Fallback、迟到奖励、LinkTree 联动和首个免费价格表现。当前导出配置也已完成对应 Mock 回归。该结论只覆盖客户端与 Mock 状态机；新版 Steam schema 尚未上传，也尚未完成真实 Steam 帐号回归。
